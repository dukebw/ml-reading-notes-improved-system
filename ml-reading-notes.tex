...
UCF101\cite{DBLP:journals/corr/abs-1212-0402} (101 classes, 13k clips and 27
hours of video data in total).
...
$C_{64} \rightarrow P_1 \rightarrow C_{128} \rightarrow P_2 \rightarrow
{(C_{256})}^2 \rightarrow P_2 \rightarrow P_2 \rightarrow
{(C_{512})}^2 \rightarrow P_2 \rightarrow {(FC_{4096})}^2 \rightarrow
\textrm{softmax}$.
...
Non-overlapping 16-frame clips were used, therefore batches of
