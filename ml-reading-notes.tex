...
\item To solve the challenges, this paper proposes solving face alignment as a
        3D problem, rather than 2D, by fitting translation, scale, rotation,
        and expression and shape parameters of a 3DMM\@.
\end{itemize}
