...
parameter~$\gamma$ in channel pruning for CNNs. ISTA has an additional term
regularization~$\grad_\gamma l_t$, where~$l_t$ is the loss, which prevents the
proceeding weight matrix from exploding in magnitude in response to~$\gamma$
(this may not have been the intention).
