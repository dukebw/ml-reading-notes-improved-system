...
\cite{DBLP:journals/corr/HeZRS15} presents a technique for deep
neural network architecture design, training of residual functions, which
allows training of deeper networks with improved accuracy compared to not
training residual functions.

\cite{DBLP:journals/corr/HeZRS15} refers to
\cite{going-deeper-szegedy43022} and \cite{DBLP:journals/corr/SimonyanZ14a} as
motivating ``very deep'' models.
